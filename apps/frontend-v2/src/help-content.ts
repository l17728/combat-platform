...
- **知识库**：全局知识文档库（技术规范/操作手册/团队文档），支持 Markdown 编辑、搜索、左侧目录列表；默认选中第一条文章，离开后记住上次选中位置。适合存放团队共享的技术资料
...
### 功能概述
知识库用于存放全局知识文档、技术规范、操作手册等结构化内容。支持 Markdown 格式，可搜索、编辑。
...
### 操作
1. 点击「新建」创建文章，输入标题和 Markdown 正文
2. 左侧列表点击文章查看内容
3. 点击编辑按钮修改标题或正文
4. 搜索框输入关键词快速过滤文章
`,
