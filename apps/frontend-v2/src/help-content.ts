...
## v2.3.0 — 2026-06-01 (知识库 + API文档 + 前端代码拆分)
...
## v2.2.0 — 2026-06-01 (邮件增强 + 邀请管理 + 运营大屏)
...
## v2.11.0 — 2026-06-01 (Webhook 事件订阅 + 邮件摘要 + 表单内联字段)
...
## v2.10.0 — 2026-06-01 (UX 中期 II: 暗黑模式 + 产品引导 + 看板配置)
