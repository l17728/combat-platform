...
import { Typography, Table, Button, Space, Modal, Form, Input, Select, message, Popconfirm, Tag, Skeleton } from "antd";
...
export default function UserManagement() {
  ...
  const columns = [
    ...
    { key: "displayName", title: "显示名", dataIndex: "displayName", ellipsis: true },
    {
      ...
      width: 100,
      render: (v: string) => (
        <Tag color={ROLE_COLOR[v] ?? "default"}>{ROLE_OPTIONS.find((r) => r.value === v)?.label ?? v}</Tag>
      ),
    },
    {
      key: "createdAt",
