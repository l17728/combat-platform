  ...
  return (
    <div>
      ...
      <Alert
        ...
        showIcon
        message="此操作不可逆"
        description="被合并方的字段与所有关系将迁移到保留方，然后删除被合并方。请谨慎操作。"
      ...
      <Card style={{ marginBottom: 16 }}>
        <Space direction="vertical" style={{ width: "100%" }} size="middle">
          ...
          <Space>
            <Button onClick={doPreview} disabled={!fromId || !toId || !!samePerson}>
              预览合并
            </Button>
            <Popconfirm
              title="合并不可逆"
              ...
              onConfirm={doMerge}
            >
              <Button danger disabled={!fromId || !toId || !!samePerson || !preview}>
                执行合并
              </Button>
            </Popconfirm>
          </Space>
