        ...
        {blocks.map((block, idx) => {
          ...
          return (
            <Card
              ...
              extra={
                <Button size="small" type="text" danger icon={<DeleteOutlined />} onClick={() => removeFaqCard(idx)} />
              }
              title={
                <Space>
...
function AIChatPanel({
  ...
  return (
    ...
    >
      ...
      >
        <Space>
          <Tooltip title="按住拖拽移动">
            <DragOutlined style={{ color: "#999" }} />
          </Tooltip>
          <RobotOutlined style={{ color: "#1890ff" }} /> AI助手
        </Space>
        <Button type="text" size="small" icon={<UpOutlined />} onClick={onClose}>
          收起
        </Button>
      </div>
