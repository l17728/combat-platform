...
const PAGES = ["/", "/attack", "/conflicts", "/honor", "/search", "/proposals", "/reminders", "/daily-report", "/releases", "/weights", "/import", "/contributions", "/hermes", "/audit", "/merge", "/email", "/emailgroups", "/incidents", "/changes", "/alarms", "/p3", "/daily", "/issue400", "/issue5xx", "/experience"];
