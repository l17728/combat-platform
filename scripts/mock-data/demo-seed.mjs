...
async function seed() {
  ...
  const infoCards = [
    { 标题: 'P1故障应急响应流程已更新', 重要程度: '重要', 信息分类: '通知', 摘要: '新版应急响应SOP正式生效', 内容: '## 应急响应流程更新\n\n1. 接到P1告警后5分钟内响应\n2. 15分钟内拉起作战群\n3. 30分钟内给出初步定位\n\n详见知识库。' },
    { 标题: '关于开展月度攻关复盘的公告', 重要程度: '一般', 信息分类: '公告', 摘要: '本月攻关复盘会定于周五下午', 内容: '请各攻关组长准备本月攻关单复盘材料，重点总结根因与改进项。' },
    { 标题: 'ModelArts OOM 问题排查经验', 重要程度: '普通', 信息分类: '经验', 摘要: 'cgroup内存限制触发OOM的定位方法', 内容: '## 排查步骤\n\n- 查看 dmesg OOM killer 日志\n- 确认 cgroup memory.limit\n- 调整 Pod requests/limits' },
    { 标题: '近期数据库主从切换风险预警', 重要程度: '重要', 信息分类: '预警', 摘要: '多个局点出现主从延迟升高', 内容: '近期 CDB/TDSQL 主从延迟升高，切换有风险，请提前评估并做好预案。' },
    { 标题: '新员工攻关平台使用指引', 重要程度: '普通', 信息分类: '通知', 摘要: '攻关平台快速上手', 内容: '登录后先在「攻关作战台」查看待处理单，贡献录入在「贡献录入」页。' },
